    ...
    <header class="flex items-center h-14 px-4 border-b border-gray-300 sm:h-16 md:px-6 lg:px-8">
      ...
      <nav class="flex flex-col ml-auto space-x-4 items-end h-10 sm:space-x-6">
        <div class="space-x-4">
          ...
          <RouterLink :to="{ name: 'home' }" exact-active-class="underline font-semibold"> Home </RouterLink>
          <RouterLink to="/features" exact-active-class="underline font-semibold"> Features </RouterLink>
          <RouterLink to="/pricing" exact-active-class="underline font-semibold"> Pricing </RouterLink>
          <RouterLink to="/contact" exact-active-class="underline font-semibold"> Contact </RouterLink>
        </div>
        <div class="space-x-4">
          <RouterLink to="/pokemon/1" exact-active-class="underline font-semibold"> Pokemon </RouterLink>
